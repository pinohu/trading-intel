...
export const trustOperationGaps: TrustOperationGap[] = [
  ...
  },
  {
    ...
    nextAction: "Promote robust strategies into deeper Alphalens/vectorbt/RQAlpha/LEAN/StockSharp/Freqtrade/Hummingbot worker tests when the systematic map shows a proof lane is missing.",
    acceptanceCriteria: [
