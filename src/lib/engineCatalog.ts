...
export const engineWorkflow = [
  ...
  "Keep FinRL, FinRL-Trading, TensorTrade, Nautilus, Jesse, OpenAlice, and all autonomous-agent lanes behind paper/live gates until broker keys and risk controls exist.",
];
