...
- Historical backtesting, research data, and ML forecast workers, including optional AKShare, StockSharp C#/.NET, and StockPredictionAI-style worker integrations.
...
flowchart LR
  ...
  TradingAgents --> DB
  BacktestWorker["Research Data + Backtest + Forecast Workers: AKShare/StockPredictionAI/LEAN/StockSharp/vectorbt/backtesting.py"] --> DB
...
- Never let TradingAgents, AKShare, StockPredictionAI, or StockSharp worker output place autonomous broker orders; manual paper/live execution stays in the broker controls and audit rail.
