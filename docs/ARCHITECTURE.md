...
- Historical backtesting, companion market-app, research data, and ML forecast workers, including optional OpenStock, AKShare, StockSharp C#/.NET, and StockPredictionAI-style worker integrations.
...
flowchart LR
  ...
  TradingAgents --> DB
  BacktestWorker["Companion + Research Data + Backtest + Forecast Workers: OpenStock/AKShare/StockPredictionAI/LEAN/StockSharp/vectorbt/backtesting.py"] --> DB
...
- Never let TradingAgents, OpenStock, AKShare, StockPredictionAI, or StockSharp worker output place autonomous broker orders; manual paper/live execution stays in the broker controls and audit rail.
