...
- Historical backtesting and ML forecast workers, including optional StockSharp C#/.NET and StockPredictionAI-style worker integrations.
...
flowchart LR
  ...
  TradingAgents --> DB
  BacktestWorker["Backtest + Forecast Workers: StockPredictionAI/LEAN/StockSharp/vectorbt/backtesting.py"] --> DB
...
- Never let TradingAgents, StockPredictionAI, or StockSharp worker output place autonomous broker orders; manual paper/live execution stays in the broker controls and audit rail.
