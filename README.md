...
- External worker bridge at `/api/research-workers/run` and `/api/research-workers/readiness` for OpenBB, OpenStock, AKShare, LEAN, StockSharp, StockPredictionAI, Backtrader, vectorbt, NautilusTrader, FinGPT, FinRL, and Jesse workers outside Vercel
...
- Engine Fusion Map covering OpenBB, OpenStock, AKShare, TradingAgents, StockPredictionAI, LEAN, StockSharp, backtesting.py, vectorbt, Backtrader, Nautilus Trader, FinRL, FinRL-Trading, FinGPT, and Jesse
...
- OpenStock, AKShare, StockPredictionAI, LEAN, StockSharp, Backtrader, vectorbt, and Nautilus external worker hooks for companion market workflows, broader research data, forecast research, and real historical backtests outside Vercel serverless limits
