...
- External worker bridge at `/api/research-workers/run` and `/api/research-workers/readiness` for OpenBB, OpenStock, StreetMerchant alert ops, Ghostfolio, AKShare, LLM Trading Lab, LEAN, StockSharp, RQAlpha, StockPredictionAI, Stock Prediction Models, Backtrader, vectorbt, NautilusTrader, FinGPT, FinRL, and Jesse workers outside Vercel
...
- Engine Fusion Map covering OpenBB, OpenStock, StreetMerchant alert ops, Ghostfolio, AKShare, TradingAgents, LLM Trading Lab, StockPredictionAI, Stock Prediction Models, LEAN, StockSharp, RQAlpha, backtesting.py, vectorbt, Backtrader, Nautilus Trader, FinRL, FinRL-Trading, FinGPT, and Jesse
