...
- External worker bridge at `/api/research-workers/run` and `/api/research-workers/readiness` for OpenBB, OpenStock, Ghostfolio, AKShare, LLM Trading Lab, LEAN, StockSharp, RQAlpha, StockPredictionAI, Stock Prediction Models, Backtrader, vectorbt, NautilusTrader, FinGPT, FinRL, and Jesse workers outside Vercel
...
- Engine Fusion Map covering OpenBB, OpenStock, Ghostfolio, AKShare, TradingAgents, LLM Trading Lab, StockPredictionAI, Stock Prediction Models, LEAN, StockSharp, RQAlpha, backtesting.py, vectorbt, Backtrader, Nautilus Trader, FinRL, FinRL-Trading, FinGPT, and Jesse
...
- OpenStock, Ghostfolio, AKShare, LLM Trading Lab, StockPredictionAI, Stock Prediction Models, LEAN, StockSharp, RQAlpha, Backtrader, vectorbt, and Nautilus external worker hooks for companion market workflows, portfolio analytics, broader research data, agent research, forecast research, and real historical backtests outside Vercel serverless limits
