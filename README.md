...
- Research Stack dashboard and `/api/research-stack/readiness` showing credentialed providers, free fallbacks, external workers, and database readiness
...
- `/api/trust-ops` endpoint exposing the trustworthy-trading-operation gap matrix and build order
...
- Trust Matrix covering licensed data, paper trading, backtesting, database, broker sync, alerts, news/catalysts, model performance, security, and PWA gaps
