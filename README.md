...
- [Dexter Worker](docs/DEXTER_WORKER.md)
...
- Alpha Vantage, Alphalens, OpenStock, StockSight, StreetMerchant, Ghostfolio, AKShare, LSTM Time Series, LLM Trading Lab, Dexter, StockPredictionAI, Stock Prediction Models, LEAN, StockSharp, RQAlpha, Freqtrade, Hummingbot, Backtrader, vectorbt, and Nautilus external worker hooks for free-account market data, factor proof, companion market workflows, sentiment/catalyst research, alert-loop operations, portfolio analytics, broader research data, agent planning/self-validation research, crypto dry-run/backtest/liquidity research, forecast research, and real historical backtests outside Vercel serverless limits
